...
public class ActionSheetDialog {
	...
	public void addShemItems(ArrayList<String> lists, OnSheetItemClickListener listener){

		for (int i=0;i<lists.size();i++){
			if (sheetItemList == null) {
				sheetItemList = new ArrayList<SheetItem>();
			}
			sheetItemList.add(new SheetItem(lists.get(i).toString(), SheetItemColor.Blue, listener));
		}
	...
	public enum SheetItemColor {
		FEN("#eb4456"),Blue("#eb4456"), Red("#FD4A2E");
