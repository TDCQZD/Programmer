 ...
 *
 * @author ZD
 *         created at 2017/8/7 15:48
 *         description：
 */
public class TelePhoneBlockActivity extends AppCompatActivity {
    // 记录黑名单的List
...
//                            telephony.endCall();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tele_phone_block);
                    ...
                    public void onClick(View v) {
                        ...
                        BaseAdapter adapter = new BaseAdapter() {
                            ...
                            public View getView(int position,
                                ...
                                CheckBox rb = new CheckBox(TelePhoneBlockActivity.this);
                        ...
                        new AlertDialog.Builder(TelePhoneBlockActivity.this)
                                .setView(selectView)
